...
<div class="row g-5 g-xl-8">
  <div class="col-xl-12 mb-8">
    <div class="card border-transparent bgi-no-repeat bgi-position-x-end bgi-size-cover " style="background-size: auto 100%; background-image: url({{ asset('admin-assets/media/illustrations/bg.png') }})">
