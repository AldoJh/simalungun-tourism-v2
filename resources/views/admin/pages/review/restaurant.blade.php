        ...
        <div class="card-body pt-6">
            <ul class="nav nav-pills nav-pills-custom mb-3" role="tablist">
                    <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                        <a href="{{ route('my-review.wisata') }}" class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" >
                    ...
                    <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                        <a href="{{ route('my-review.restoran') }}" class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active" >
                            <div class="nav-icon mb-3">  
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-7">
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-100px me-5">                                                   
                                        <img src="{{ Storage::url($item->restaurant->image) }}" class="" alt="">                                                    
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <span class="text-gray-800 fw-bold text-hover-primary mb-1 fs-4">{{ $item->restaurant->name }}</span>
                            ...
                            <div>
                                <a id="{{ route('my-review.restoran.destroy', $item->id) }}" class="btn btn-del btn-sm btn-light btn-active-light-primary btn-flex btn-center btn-icon">
