      ...
      <div class="card card-flush">
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
          ...
          <div class="card-toolbar">
            <form method="GET" action="{{ route('admin.berita.berita') }}" class="card-title">
              <input type="hidden" name="page" value="{{ request('page', 1) }}">
              <div class="input-group d-flex align-items-center position-relative my-1">
                <input type="text"  class="form-control form-control-solid  ps-5 rounded-0" name="q" value="{{ request('q') }}" placeholder="Cari Berita" />
            ...
            <table class="table table-row-dashed fs-6 gy-5">
              <thead>
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                  ...
                  <th class="text-center min-w-125px">Penulis</th>
                  <th class="text-center min-w-125px">Tanggal Posting</th>
                      ...
                      <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.berita.berita.komentar', $item->id) }}" class="menu-link px-3">Komentar</a>
                          </div>
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.berita.berita.galeri', $item->id) }}" class="menu-link px-3">Galeri</a>
                          </div>
                          <div class="menu-item px-3">
