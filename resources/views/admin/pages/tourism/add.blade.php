...
@section('content')
  ...
  <form action="{{ route('admin.wisata.wisata.store') }}" enctype="multipart/form-data" method="post" class="row g-5 g-xl-8">
    @csrf
          ...
          <div class="card-body pt-5">
            ...
            <div>
              ...
              <div class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input" type="checkbox" name="recomended" @if (old('recomended')) checked @endif id="flexSwitchDefault"/>
              </div>
            </div>
          </div>
        </div>
