        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
          <div class="card-title">
            <h3 class="card-title align-items-start flex-column">
              ...
              <span class="text-muted fw-semibold fs-7">Review wisata</span>
            </h3>
          </div>
        </div>
            ...
            <table class="table table-row-dashed fs-6 gy-5">
              <thead>
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                  ...
                  <th class="min-w-125px">wisata</th>
                ...
                @else
                  @foreach ($review as $item)     
                    <tr>
                      ...
                      <td>
                        <div>
                          <div class="fs-6 fw-bold">{{ $item->tourism->name }}</div>
                          <span class="text-muted text-10">{{ $item->tourism->slug }}</span>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex">
                      ...
                      <td class="text-end">
                        <a id="{{ route('admin.wisata.review.destroy', $item->id) }}" class="btn btn-del btn-sm btn-light btn-active-light-primary btn-flex btn-center btn-icon">
