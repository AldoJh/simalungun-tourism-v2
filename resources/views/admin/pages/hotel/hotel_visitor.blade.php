    ...
    <div class="card-body pt-9 pb-0">
      ...
      <div class="d-flex overflow-auto h-55px">
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
          <li class="nav-item">
            <a href="{{ route('admin.hotel.hotel.pengunjung', $hotel->id) }}" class="nav-link text-active-primary me-6 active ">Pengunjung</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('admin.hotel.hotel.review', $hotel->id) }}" class="nav-link text-active-primary me-6">Review</a>
          </li>
          <li class="nav-item">
      ...
      <div class="card-toolbar">
        ...
        <div class="modal fade" tabindex="-1" id="add">
          <div class="modal-dialog">
              <form method="POST" action="{{ route('admin.hotel.hotel.pengunjung.store', $hotel->id) }}" class="modal-content" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="required form-label">Jumlah Kamar</label>
            ...
            @else
              @foreach ($visitor as $item)     
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <div class="fs-6 fw-bold">{{ $item->room }}</div>
                    </div>
                  </td>
                  <td>
                    <div class="d-flex">
                  ...
                  <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                      ...
                      <div class="menu-item px-3">
                        <a id="{{ route('admin.hotel.hotel.pengunjung.destroy', ['id' => $hotel->id, 'idVisitor' => $item->id]) }}" class="menu-link px-3 btn-del">Hapus</a>
                      </div>
                    </div>
                  </td>
                </tr>
...
@foreach ($visitor as $item)     
  <div class="modal fade" tabindex="-1" id="edit{{ $item->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('admin.hotel.hotel.pengunjung.update', ['id' => $hotel->id, 'idVisitor' => $item->id]) }}" class="modal-content" enctype="multipart/form-data">
          @csrf
            <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="required form-label">Jumlah Kamar</label>
                <input type="number" name="room" class="form-control form-control-solid @error('room') is-invalid @enderror"  value="{{ old('room') ?? $item->room }}" placeholder="Jumlah Pengunjung" required/>
                @error('room')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
