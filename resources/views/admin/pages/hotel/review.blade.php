        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
          <div class="card-title">
            <h3 class="card-title align-items-start flex-column">
              ...
              <span class="text-muted fw-semibold fs-7">Review hotel</span>
            </h3>
          </div>
        </div>
                ...
                @else
                  @foreach ($review as $item)     
                    <tr>
                      ...
                      <td class="text-end">
                        <a id="{{ route('admin.hotel.review.destroy', $item->id) }}" class="btn btn-del btn-sm btn-light btn-active-light-primary btn-flex btn-center btn-icon">
