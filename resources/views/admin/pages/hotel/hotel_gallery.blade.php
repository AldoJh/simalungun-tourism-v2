    ...
    <div class="card-body pt-9 pb-0">
      ...
      <div class="d-flex overflow-auto h-55px">
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.hotel.hotel.galeri', $hotel->id) }}" class="nav-link text-active-primary me-6  active">Galeri</a>
          </li>
          <li class="nav-item">
      ...
      @foreach ($gallery as $item)  
        <div class="col-auto">
          <div class="image-input image-input-outline">
            ...
            <a href="{{ route('admin.hotel.hotel.galeri.destroy', ['id' => $hotel->id, 'idGallery' => $item->id]) }}" class="btn-del">
...
<div class="modal fade" tabindex="-1" id="upload">
  <div class="modal-dialog modal-dialog-centered">
      <form method="POST" action="{{ route('admin.hotel.hotel.galeri.store', $hotel->id) }}" enctype="multipart/form-data" class="modal-content">
        @csrf
