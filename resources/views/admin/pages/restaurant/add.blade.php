          ...
          <div class="card-body pt-0">
            <div class="row">
              ...
              <div class="col-4 mb-3 mt-9">
                ...
                <select name="label" class="form-control form-select form-control-solid @error('label') is-invalid @enderror" required>
                  ...
                  <option @if (old('label') == 1) selected  @endif value="1">Halal</option>
                  <option @if (old('label') == 0) selected  @endif value="0">Non-Halal</option>
                </select>
                @error('label')
                <div class="invalid-feedback">
                  {{ $message }}
            ...
            <div class="row">
              <div class="col mb-5">
                ...
                <input type="number" name="table" class="form-control form-control-solid @error('table') is-invalid @enderror" value="{{ old('table') }}" placeholder="Jumlah meja" required/>
                @error('table')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="col mb-5">
                ...
                <input type="number" name="chair" class="form-control form-control-solid @error('chair') is-invalid @enderror" value="{{ old('chair') }}" placeholder="Jumlah kursi" required/>
                @error('chair')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
