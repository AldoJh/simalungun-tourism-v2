        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
          <div class="card-title">
            <h3 class="card-title align-items-start flex-column">
              ...
              <span class="text-muted fw-semibold fs-7">Data Restoran</span>
            </h3>
          </div>
          <div class="card-toolbar">
            <form method="GET" action="{{ route('admin.restoran.restoran') }}" class="card-title">
              <input type="hidden" name="page" value="{{ request('page', 1) }}">
              <div class="input-group d-flex align-items-center position-relative my-1">
                <input type="text"  class="form-control form-control-solid  ps-5 rounded-0" name="q" value="{{ request('q') }}" placeholder="Cari restoran" />
            ...
            <a href="{{ route('admin.restoran.restoran.add') }}" class="btn btn-primary d-flex align-items-center"><i class="ki-duotone ki-plus fs-2"></i>
              Tambah
            </a>
          </div>
        </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-5">
                            <a href="{{ route('restoran.show', $item->slug) }}" target="_blank" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1">
                              {{ $item->name }}
                              @if ($item->label) <span class="badge text-white bg-success">Halal</span> @else <span class="badge text-white bg-warning">Non-Halal</span> @endif 
                        ...
                        <div class="text-center">
                          <div class="fs-6 fw-bold d-flex align-items-center">
                            @if (count($item->restaurantReview) > 0)
                              ...
                              @endfor
                              <span class="ms-2">{{ round($item->restaurantReview->average('rating'), 1) }} ({{ count($item->restaurantReview) }})</span>
                            @else
                      ...
                      <td>
                        <div class="text-center">
                          <div class="fs-6 fw-bold">{{ $item->restaurantVisitor->sum('visitor') }}</div>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <div class="fs-6 fw-bold">{{ count($item->restaurantViewer) }}</div>
                        </div>
                      </td>
                      <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.restoran.restoran.pengunjung', $item->id) }}" class="menu-link px-3">Pengunjung</a>
                          </div>
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.restoran.restoran.review', $item->id) }}" class="menu-link px-3">Review</a>
                          </div>
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.restoran.restoran.galeri', $item->id) }}" class="menu-link px-3">Galeri</a>
                          </div>
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.restoran.restoran.menu', $item->id) }}" class="menu-link px-3">Menu</a>
                          </div>
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.restoran.restoran.admin', $item->id) }}" class="menu-link px-3">Admin</a>
                          </div>
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.restoran.restoran.edit', $item->id) }}" class="menu-link px-3">Edit</a>
                          </div>
                          <div class="menu-item px-3">
                            <a id="{{ route('admin.restoran.restoran.destroy', $item->id) }}" class="menu-link px-3 btn-del">Hapus</a>
                          </div>
                        </div>
                      </td>
                    </tr>
