...
@section('content')
  ...
  <form action="{{ route('admin.festival.festival.update', $event->id) }}" enctype="multipart/form-data" method="post" class="row g-5 g-xl-8">
    @csrf
        ...
        <div class="card card-flush">
          ...
          <div class="card-body text-center pt-0">
            <div class="image-input image-input-empty" data-kt-image-input="true">
              <div class="image-input-wrapper w-200px h-150px" style="background-image: url('{{ Storage::url( $event->image) }}')"></div>
        ...
        <div class="card card-flush">
          <div class="card-body pt-0">
            <div class="mb-3 mt-9">
              ...
              <input type="number" name="price" class="form-control form-control-solid @error('price') is-invalid @enderror" value="{{ old('price') ?? $event->price}}" required/>
              @error('price')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div>
              ...
              <input type="date" name="date" class="form-control form-control-solid @error('dae') is-invalid @enderror" value="{{ old('date') ?? $event->date }}" required/>
              @error('date')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="card card-flush">
          <div class="card-body pt-0">
            <div class="mb-3 mt-9">
              ...
              <input type="text" name="name" class="form-control form-control-solid @error('name') is-invalid @enderror" value="{{ old('name') ?? $event->name }}" placeholder="Nama Festival" required/>
              @error('name')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="mb-5">
              ...
              <input type="text" name="location" class="form-control form-control-solid @error('location') is-invalid @enderror" value="{{ old('location') ?? $event->address }}" placeholder="Lokasi"/>
              @error('location')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="row">
              <div class="col mb-5">
                ...
                <input type="number" name="lat" class="form-control form-control-solid @error('lat') is-invalid @enderror" value="{{ old('lat') ?? $event->latitude }}" placeholder="Latitude"/>
                @error('lat')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="col mb-5">
                ...
                <input type="number" name="long" class="form-control form-control-solid @error('long') is-invalid @enderror" value="{{ old('long') ?? $event->longitude }}" placeholder="Longitude"/>
                @error('long')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
