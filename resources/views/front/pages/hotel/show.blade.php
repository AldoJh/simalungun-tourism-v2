...
@section('seo')
  ...
  <meta property="og:url" content="{{ route('restoran.show', $hotel->slug) }}" />
  <meta property="og:title" content="{{$hotel->name ?? ''}}" />
  <meta property="og:type" content="article" />
  <meta property="og:image" content="{{url(Storage::url($hotel->image))}}" />
  <meta
    property="og:description"
    content="{{ $hotel->excerpt }}"
  />
  ...
  <meta
    ...
    content="{{ $hotel->excerpt }}"
  />
  <meta name="twitter:image" content="{{url(Storage::url($hotel->image))}}" />
  ...
  <!-- Canonical Tag -->
  <link rel="canonical" href="{{ route('restoran.show', $hotel->slug) }}" />
...
<div data-anim="fade" class="container">
  <div class="row justify-between py-30 mt-80">
    <div class="col-12">
      <div class="text-14">Home > Hotel > {{ $hotel->slug }}</div>
    </div>
    <div class="col-12">
        ...
        @if (count($hotel->hotelReview) > 0)
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              {{ round($hotel->hotelReview->average('rating'), 1) }} ({{ count($hotel->hotelReview) }})
            </div>
          </div>
        @else
        <div class="col-auto">
          ...
          <div class="d-flex x-gap-30 y-gap-10">
            <div class="dropdown -base -price js-dropdown js-form-dd" data-main-value="">
              ...
              <div class="dropdown__menu px-30 py-30 shadow-1 border-1 js-">
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('restoran.show', $hotel->slug) }}" target="_blank" class="dropdown__button h-50 min-w-auto js-button -outline-dark-1">
                ...
                <a href=" http://www.linkedin.com/shareArticle?mini=true&url={{ route('restoran.show', $hotel->slug) }}" target="_blank" class="dropdown__button h-50 min-w-auto js-button -outline-dark-1 mt-10">
                  <div class="d-flex flex-center text-16 ">
                ...
                <a href="https://api.whatsapp.com/send?&text={{ route('restoran.show', $hotel->slug) }}" target="_blank" class="dropdown__button h-50 min-w-auto js-button -outline-dark-1 mt-10">
                  <div class="d-flex flex-center text-16">
      ...
      <div class="col-lg-8">
        <div class="js-section-slider" data-gap="10" data-slider-cols="xl-1 lg-1 md-1 sm-1 base-1" data-nav-prev="js-sliderMain-prev" data-nav-next="js-sliderMain-next" data-loop>
          <div class="swiper-wrapper">
            ...
            @foreach ($hotel->hotelImage as $item)
  ...
  <div class="container">
    <div class="row y-gap-30">
      <div class="col-lg-8">
          ...
          <div class="col-lg-3 col-6">
            <div class="d-flex items-center">
              ...
              <div class="ml-10">
                ...
                <div class="text-14 text-light-2 lh-16">{{ $hotel->hotelCategory->name }}</div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            <div class="d-flex items-center">
              ...
              <div class="ml-10">
                ...
                <div class="text-14 text-light-2 lh-16">1{{ $hotel->room }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mt-20">
          {!! $hotel->description !!}
          <h6 class="fw-bold">Owner : {{ $hotel->owner }}</h6>
        </div>
       ...
       <div class="row x-gap-130 y-gap-20 pt-20">
          <div class="col-lg-6">
            <div class="y-gap-15">
              @foreach ($hotel->hotelFacility as $item)
              @endforeach
              <div class="d-flex">
        ...
        @if (Auth::check())
        <form method="POST" action="{{ route('hotel.review', $hotel->id) }}" class="contactForm y-gap-30 pt-20 mb-lg-20 pb-20">
          @csrf
          <div class="row">
            <div class="col-12">
              <div class="pb-20">
        ...
        <div class="row mt-10">
          <div class="col-12">
            <a href="{{ route('login') }}?route={{ route('restoran.show', $hotel->slug) }}" class="text-accent-1">
              <u>Masuk Dulu
      ...
      <div class="col-lg-4">
        <div class="d-flex justify-end js-pin-content">
          <div class="tourSingleSidebar">
              ...
              <div class="searchForm__form">
                <div class="searchFormItem js-select-control js-form-dd js-calendar">
                  <div class="searchFormItem__button" data-x-click="calendar">
                    ...
                    <div class="searchFormItem__content">
                      <h5>Telepon</h5>
                      <span class="js-first-date">{{ $hotel->phone }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="searchFormItem js-select-control js-form-dd">
                  <div class="searchFormItem__button" data-x-click="time">
                    ...
                    <div class="searchFormItem__content">
                      <h5>Lokasi</h5>
                      <div class="js-select-control-chosen">{{ $hotel->address }}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="text-18 fw-400">Rp. {{ number_format($hotel->min_price) }} - Rp. {{ number_format($hotel->max_price) }} </div>
            <a href="https://maps.google.com/?q={{ $hotel->latitude }},{{ $hotel->longitude }}" target="_blank" class="button -md -dark-1 col-12 bg-accent-1 text-white mt-20">
              Lihat Rute
