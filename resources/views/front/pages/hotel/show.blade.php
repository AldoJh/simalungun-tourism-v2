  ...
  <div class="row justify-between py-30 mt-80">
    <div class="col-auto">
      <div class="breadcrumbs">
        ...
        <span>></span>
        <span class="breadcrumbs__item">
          <a href="{{ route('hotel.show', $hotel->slug ) }}">{{ $hotel->slug }}</a>
        </span>
      </div>
    </div>
    <div class="col-12">
          ...
          <div class="d-flex x-gap-30 y-gap-10">
            <div class="dropdown -base -price js-dropdown js-form-dd" data-main-value="">
              ...
              <div class="dropdown__menu px-30 py-30 shadow-1 border-1 js-">
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('hotel.show', $hotel->slug) }}" target="_blank" class="dropdown__button h-50 min-w-auto js-button -outline-dark-1">
                ...
                <a href=" http://www.linkedin.com/shareArticle?mini=true&url={{ route('hotel.show', $hotel->slug) }}" target="_blank" class="dropdown__button h-50 min-w-auto js-button -outline-dark-1 mt-10">
                  <div class="d-flex flex-center text-16 ">
                ...
                <a href="https://api.whatsapp.com/send?&text={{ route('hotel.show', $hotel->slug) }}" target="_blank" class="dropdown__button h-50 min-w-auto js-button -outline-dark-1 mt-10">
                  <div class="d-flex flex-center text-16">
