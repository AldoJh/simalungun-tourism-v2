...
<body>
  ...
  <main>
    ...
    <div style="position: relative;" class="mt-50 pt-50">
      <div class="row justify-content-center  d-flex z-10">
          <div class="col-lg-5 col-11 col-md-10 feedback" style="margin-bottom: 420px">
              <div class="hero__filter">
                  <div class="searchForm -type-1 shadow-1 rounded d-flex justify-between shadow-lg"
                      style="background-image: url('{{ asset('front-assets/img/bg-kuisioner.png') }}') !important;">
                      <div class="ms-3">
                          <h5>Kuisioner</h5>
                      ...
                      <div class="searchForm__button">
                          <a href="{{ route('kuisioner') }}"
                              class="pt-10 pb-10 pl-10 pr-10 button -dark-1 bg-accent-1 rounded text-white">
                              Isi Kuisioner
                          </a>
                      </div>
                  </div>
      ...
      <footer class="footer -type-1 bg-accent-1-05" style="position: absolute; bottom: 0; width: 100%;">
                              ...
                              <div class="row y-gap-20 items-center">
                                  ...
                                  <div class="col-auto">
                                      <div class="text-20 fw-500">
                                          Info Lebih Lanjut
                                          <span
                                              class="text-accent-1">{{ \App\Models\Setting::webBase()->whatsapp }}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="col-auto">
                              <div class="footerSocials">
                                  ...
                                  <div class="footerSocials__icons">
                                      <a href="{{ \App\Models\Setting::webBase()->facebook }}"
                                          class="icon-facebook"></a>
                                      <a href="{{ \App\Models\Setting::webBase()->instagram }}"
                      ...
                      <div class="row">
                          <div class="col-12 text-center">
                              <div class="y-gap-10 mt-20">
                                  <span
                                      class="d-block">{!! \App\Models\Setting::webBase()->description !!}</span>
                              </div>
                          </div>
                      </div>
                  </div>
