    ...
    <div data-anim="slide-up" class="row justify-center">
      <div class="col-xl-6 col-lg-7 col-md-9">
        <div class="text-center mb-60 md:mb-30">
          <h1 class="text-30">Lupa Password?</h1>
          <div class="text-18 fw-500 mt-20 md:mt-15">Masukan email anda untuk mereset password</div>
        </div>
        <form method="POST" action="{{ route('forget.submit') }}" class="contactForm border-1 rounded-12 px-60 py-60 md:px-25 md:py-30">
          @csrf
